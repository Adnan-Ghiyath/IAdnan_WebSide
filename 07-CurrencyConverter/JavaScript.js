...
const UI = {
  ...
  btnUseUSDUAE: document.getElementById("btnUseUSDUAE"),
...
function setLoading(isLoading) {
  ...
  UI.btnUseUSDUAE.disabled = isLoading;
...
async function loadCurrencies() {
  ...
  UI.to.value = "UAE";
  if (!currencyMap["UAE"]) UI.to.value = "EUR";
...
// ✅ Preset: USD → UAE (fallback to EUR if UAE missing)
UI.btnUseUSDUAE.addEventListener("click", () => {
  UI.from.value = "USD";
  UI.to.value = currencyMap["UAE"] ? "UAE" : "EUR";
  run();
});
